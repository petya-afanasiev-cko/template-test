package com.checkout.settlement.dci.event;
...
import static com.checkout.settlement.dci.utils.StringParser.moneyNanos;
import static com.checkout.settlement.dci.utils.StringParser.moneyUnits;
    ...
    return SettlementEvent.newBuilder()
        ...
        .setSettlement(Settlement.newBuilder()
            ...
            .setGrossSettlementAmount(Money.newBuilder()
                .setCurrencyCode("dci_recap.currency_key")
