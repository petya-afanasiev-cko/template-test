...
@Configuration
@ComponentScan(basePackages = {"com.checkout.settlement.loader.reader", "com.checkout.settlement.{{ cookiecutter.scheme_slug }}.t112", "com.checkout.settlement.{{ cookiecutter.scheme_slug }}.event"})
public class TestConfig {
  ...
  public FlatFileItemReader<FileLineRecord> localFileReader(
    ...
    return new FlatFileItemReaderBuilder<FileLineRecord>()
        ...
        .lineMapper((l, ln) -> new UnknownRecord("", ln, l)) // override in step
        .build();
  }
  ...
  public BinaryItemReader<FileLineRecord> iso8583S3FileReader(
    ...
    return new BinaryItemReader<>((new ClassPathResource(jobParameters.get("fileName"))).getInputStream(), 1024);
  }
}
